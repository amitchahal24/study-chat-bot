...
class _QuizEntryScreenState extends State<QuizEntryScreen> {
  ...
  Future<void> _saveQuizEntry() async {
    ...
    final answers = _answersTextEditingController.text;
    ...
    var apiResponse = await ApiService.post('quiz', {'userId': userId, 'title': title, 'answer_key': answers, 'quiz_entry': body});
